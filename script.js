const SITE_SETTINGS = {
  ...
  stickerMessages: {
    ...
    en: [
      ...
      ["Glow Moment", "Beauty and fragrance for everyone."],
...
const translations = {
  ar: {
    ...
    picksIntro: "3 عطور رجالي و3 عطور حريمي مختارين كبداية من براند NŌRÉVA.",
  ...
  en: {
    ...
    picksIntro: "Three men fragrances and three women fragrances selected from NŌRÉVA.",
